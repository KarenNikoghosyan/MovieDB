...
public class ActionAPIManager {
    ...
    public void getAction(MutableLiveData<List<Movie>> moviesLiveData, MutableLiveData<Throwable> exceptionCallback) {
        page++;
        Call<MovieResponse> movieHTTPRequest = genreService.getAction(page);
        ...
        movieHTTPRequest.enqueue(new Callback<MovieResponse>() {
            ...
            public void onResponse(Call<MovieResponse> call, Response<MovieResponse> response) {
                ...
                if (movieResponse != null) {
                    ...
                    numberOfCalls--;
                    if (numberOfCalls > 0) {
                        getAction(moviesLiveData, exceptionCallback);
                    }
                    else {
