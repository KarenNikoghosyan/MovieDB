...
public class TopRatedAPIManager {
    ...
    public void getTopRated(MutableLiveData<List<Movie>> moviesLiveData, MutableLiveData<Throwable> exceptionCallback) {
        page++;
        Call<MovieResponse> movieHTTPRequest = genreService.getTopRated(page);
        ...
        movieHTTPRequest.enqueue(new Callback<MovieResponse>() {
            ...
            public void onResponse(Call<MovieResponse> call, Response<MovieResponse> response) {
                ...
                if (movieResponse != null) {
                    ...
                    numberOfCalls--;
                    if (numberOfCalls > 0) {
                        getTopRated(moviesLiveData, exceptionCallback);
                    }
                    else {
